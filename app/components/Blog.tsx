...
const posts = [
  {
    ...
    description: 'Learn about the latest trends in cryptocurrency markets and how they affect your investment strategy.',
    category: 'Cryptocurrency',
    date: 'Mar 16, 2024',
    readTime: '5 min read',
    image: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
  },
  {
    id: 2,
    title: 'Essential Risk Management Strategies',
    description: 'Discover key strategies to protect your investments and minimize risks in volatile markets.',
  ...
  },
  {
    ...
    description: 'Tips and strategies for creating a well-balanced investment portfolio across different asset classes.',
    ...
    <section id="blog" className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base font-semibold leading-7 text-blue-600">Blog</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Latest Insights & Market Analysis
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Stay informed with our latest articles on financial markets, investment strategies, and cryptocurrency trends.
          </p>
        </div>
